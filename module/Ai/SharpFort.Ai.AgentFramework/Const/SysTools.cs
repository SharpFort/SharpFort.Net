...
using SharpFort.Ai.AgentFramework.Tools;

namespace SharpFort.Ai.AgentFramework.Const;

public static class SysTools
{
    public static Dictionary<string, AITool> Tools { get; set; } = new()
    {
        {
        ...
        },
        {
            ...
            {
                Name = "RunPythonPy",
                Description = "执行Python脚本。 可以帮助Skills工具执行scripts中含有后缀.py脚本的能力 通过PythonNet库来调用Python.py的脚本,并返回执行脚本结果"
            })
        },
        {
