...
public class SpecialCompatible(IOptions<SpecialCompatibleOptions> options) : ISpecialCompatible, ISingletonDependency
{
    private readonly IOptions<SpecialCompatibleOptions> _options = options;
