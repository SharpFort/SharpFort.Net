...
namespace SharpFort.Ai.Domain.Shared.Dtos.OpenAi.Images;
...
public record ImageCreateResponse : ThorBaseResponse
{
    ...
    public record ImageDataResult
    {
        ...
        [JsonPropertyName("b64_json")] public string B64 { get; set; } = null!;
        [JsonPropertyName("revised_prompt")] public string RevisedPrompt { get; set; } = null!;
    }
}
