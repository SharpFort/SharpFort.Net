...
using Yi.Framework.CasbinRbac.Application.Contracts.Dtos.LoginLog;
using Yi.Framework.CasbinRbac.Domain.Entities;
using Yi.Framework.SqlSugarCore.Abstractions;

namespace Yi.Framework.CasbinRbac.Application.Services.RecordLog
{
    public class LoginLogService : YiCrudAppService<LoginLog, LoginLogGetListOutputDto, Guid, LoginLogGetListInputVo>
    {
