...
namespace Yi.Framework.CasbinRbac.Application.Services.Authentication
{
    /// <summary>
    /// 第三方授权服务
    /// </summary>
    public class AuthService :
        YiCrudAppService<OpenAuth, AuthOutputDto, Guid, AuthGetListInput, AuthCreateOrUpdateInputDto>,
        IAuthService
    {
