...
namespace Yi.Framework.CasbinRbac.Application.Services
{
    public class AccountService : ApplicationService, IAccountService
    {
        ...
        public async Task<LoginOutputDto> PostLoginAsync(Guid userId)
        {
            ...
            {
                //var loginEntity = new LoginLog().GetInfoByHttpContext(_httpContextAccessor.HttpContext);
        ...
        {
            return await PostCaptchaPhoneAsync(PhoneValidationType.Register, input);
        }
        ...
        public async Task<object> GetVue3Router([FromRoute] string? routerType)
        {
            ...
            if (routerType is null || routerType == "ruoyi")
            {
                ...
                output =
                    ObjectMapper.Map<List<MenuDto>, List<Menu>>(menus.Where(x=>x.MenuSource==MenuSource.Ruoyi).ToList()).Vue3RuoYiRouterBuild();
            }
