...
using SharpFort.FileManagement.Application.Contracts.Dtos.FileDescriptor;
using SharpFort.FileManagement.Application.Contracts.IServices;
using SharpFort.FileManagement.Domain.Entities;
using SharpFort.FileManagement.Domain.Managers;
using SharpFort.SqlSugarCore.Abstractions;

namespace SharpFort.FileManagement.Application.Services
{
    /// <summary>
    /// 文件描述符服务
