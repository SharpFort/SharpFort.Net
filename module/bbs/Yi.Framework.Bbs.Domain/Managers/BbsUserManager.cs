...
namespace Yi.Framework.Bbs.Domain.Managers
{
    ...
    {
        public ISqlSugarRepository<User> _userRepository;
        ...
        public async Task VerifyUserLimitAsync(Guid userId)
        {
            ...
            if (userInfo.UserLimit == UserSafetyStatus.Banned)
            {
                throw new UserFriendlyException("你已被禁用，如存疑虑，请联系管理员进行申诉");
            }
            if (userInfo.UserLimit == UserSafetyStatus.HighRisk)
            {
    ...
    public class BbsUserInfoDto
    {
        ...
        /// 用户限制
        /// </summary>
        public UserSafetyStatus UserLimit { get; set; }
