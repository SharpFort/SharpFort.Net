...
namespace Yi.Framework.Bbs.Domain.Managers.ArticleImport
{
    public abstract class AbstractArticleImport
    {
        ...
        public virtual List<Article> Import(Guid discussId, Guid articleParentId, List<FileObject> fileObjs)
        {
        ...
        public abstract List<Article> Convert(List<FileObject> fileObjs);
    }
}
