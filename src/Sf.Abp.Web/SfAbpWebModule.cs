...
namespace Sf.Abp.Web
{
    [DependsOn(
        ...
        typeof(SharpFortAspNetCoreModule),
        typeof(SharpFortAspNetCoreAuthenticationOAuthModule),
        typeof(SharpFortBackgroundWorkersHangfireModule),
    ...
    public class SfAbpWebModule : AbpModule
    {
        ...
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(SfAbpApplicationModule).Assembly,
                    options => options.RemoteServiceName = "default");
                options.ConventionalControllers.Create(typeof(SharpFortTenantManagementApplicationModule).Assembly,
                    options => options.RemoteServiceName = "tenant-management");
                options.ConventionalControllers.Create(typeof(SharpFortCodeGenApplicationModule).Assembly,
                    options => options.RemoteServiceName = "code-gen");
                options.ConventionalControllers.Create(typeof(SharpFortSettingManagementDomainModule).Assembly,
                    options => options.RemoteServiceName = "setting-management");
                options.ConventionalControllers.Create(typeof(SharpFortCasbinRbacApplicationModule).Assembly,
                    options => options.RemoteServiceName = "casbin-rbac");
                options.ConventionalControllers.Create(typeof(SharpFortFileManagementApplicationModule).Assembly,
                ...
                options.ConventionalControllers.Create(typeof(SharpFortAiApplicationModule).Assembly,
        ...
        public override Task ConfigureServicesAsync(ServiceConfigurationContext context)
        {
            ...
            //Swagger
            context.Services.AddSfSwaggerGen<SfAbpWebModule>(options =>
            {
                options.SwaggerDoc("default",
                    new OpenApiInfo { Title = "SharpFort.Abp", Version = "v1", Description = "集大成者" });
            });
