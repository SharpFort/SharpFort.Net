...
namespace Yi.Framework.Bbs.Domain.Entities.Bank
{
    ...
    public class BankCard : AggregateRoot<Guid>, IHasCreationTime
    {
        ...
        /// 银行卡状态
        /// </summary>
        public BankCardStatus BankCardState { get; set; } = BankCardStatus.Idle;
        ...
        {
            this.BankCardState = BankCardStatus.Idle;
        ...
        public void SetStorageMoney(decimal storageMoney)
        {
            ...
            this.BankCardState = BankCardStatus.Waiting;
        }
    }
}
