...
namespace Yi.Framework.Bbs.Application.Services.Bank
{
    public class BankService : ApplicationService
    {
        ...
        private ISqlSugarRepository<BankCard, Guid> _repository;
        private ISqlSugarRepository<InterestRecords, Guid> _interestRepository;
        public BankService(BankManager bankManager, BbsUserManager userManager, ISqlSugarRepository<BankCard, Guid> repository, ISqlSugarRepository<InterestRecords, Guid> interestRepository)
        {
