# SharpFort (原 SharpFort) 项目上下文

## 项目概述

**SharpFort** 是一个基于 .NET 8、ABP Framework v8.3 和 SqlSugar ORM 的 DDD (领域驱动设计) 后端开源框架。该项目由原 **SharpFort** Fork 而来，由新维护者长期维护和发展。
...
SharpFort.Net8/
├── framework/                    # 框架层 (11个项目)
│   ├── SharpFort.Core/        # 核心工具类库
│   │   └── Helper/              # 自定义帮助类 (27个)
│   ├── SharpFort.AspNetCore/  # ASP.NET Core 集成
...
│   └── code-gen/                # 代码生成
├── src/                          # 应用层
│   ├── SharpFort.Web/              # Web 主项目
│   ├── SharpFort.Application/
│   ├── SharpFort.Application.Contracts/
│   ├── SharpFort.Domain/
│   ├── SharpFort.Domain.Shared/
│   └── SharpFort.SqlSugarCore/
└── test/                         # 测试项目
```
...
- **位置**: `module/rbac/SharpFort.Rbac.Domain/Entities/UserAggregateRoot.cs:190-191`
